        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:sahaniamith5.as@gmail.com">sahaniamith5.as@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            A goal-oriented Software Developer and Data Analyst with experience in building web applications using modern technologies
            like React, Next.js, Applying my expertise in the fields of Big Data, Generative AI, Web development, and Data Science.
          </p>

          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="/AmithSahaniResume.pdf"
              target="_blank"
              download
            >
            ...
            <Link
              href="https://github.com/amith1315"
              target="_blank"
            >
            ...
            <Link
              href="mailto:sahaniamith5.as@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://x.com/AmithS23190765"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/amith-sahani/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
